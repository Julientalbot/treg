...
| [Endpoint catalog — what you can DO with a connected key, and which provider should do it](architecture/catalog.md) | shipped | tavily.yaml, exa.yaml, anyapi.extended.yaml, trestleiq.yaml, … |
